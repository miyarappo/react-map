...
export const setErrorMessage = message => dispatch => dispatch({ type: 'CHANGE_ERROE_MESSAGE', message });

export const setHotels = hotels => dispatch => dispatch({ type: 'CHANGE_HOTELS', hotels });

export const setSortKey = sortKey => dispatch => dispatch({ type: 'CHANGE_SORTKEY', sortKey });
